...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGVtbzA4IiwiYSI6ImNsZWN5Y3NtODAxNzMzc3MyYXh1MjVnNGcifQ.A2HAanjnhoY8pYLrnjyAcA';
  var map = new mapboxgl.Map({
    container: 'map',
    // needed in html with id map
    style: 'mapbox://styles/demo08/cled5048s000t01msse82n3ht',
    scrollZoom: false
    // interactive: false,
  });

  var bounds = new mapboxgl.LngLatBounds(); // The area that will be displayed in our map
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success' || res.data.statusbar === 'success') {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success' || res.data.statusbar === 'success') location.reload(true);
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Mcnq5SAvG3zOkKWTpiO05l4fUUdHMoEyLPY8pz4DVhHbeFpoy5DBns07UZWfCK53l2kz1Z8y51muEPZEgkUWsFa00MZY7yGsm');
